...
Arkanoid::Scene::SceneQuestionYesNo::SceneQuestionYesNo(std::string question)
{
...
Arkanoid::Scene::SceneCommand Arkanoid::Scene::SceneQuestionYesNo::handleInput(sf::Event& event)
{
    EnumScene::QuestionYesNo cmd = this->_inputMenu.Update(event);
    return this->handlersQuestionYesNo(cmd);
}

Arkanoid::Scene::SceneCommand Arkanoid::Scene::SceneQuestionYesNo::update(float dt)
{
...
void Arkanoid::Scene::SceneQuestionYesNo::draw(sf::RenderWindow& window)
{
